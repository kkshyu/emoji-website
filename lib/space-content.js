...
- 白日咖啡，入夜為酒
- 不用會員，一杯咖啡就是入場券`,
  space_1f_en: `By day: Japanese set meals and pour-over coffee, with a takeout window. After dark the lights warm — late-night shokudō and bar. This is the doorway to the hub, where the meetings begin.

- About 25 ping; 20–30 seats, long counter, takeout window
- Open to everyone — a coffee is your ticket in`,
  space_1f_ja: `昼は明るい日式定食とハンドドリップ。テイクアウト窓口あり。夜は灯りを落とし、深夜食堂とバーへ。ここはタレントハブの入口。出会いは一杯から始まります。
