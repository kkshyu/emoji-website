...
(function (global) {
  ...
  const LAYERS = [
    {
      key: 'awareness', name: '陌生觸及', budget: 30000,
      audience: '24–39 歲；台北與通勤新北；廣泛受眾（不用興趣標籤切細）',
      goal: '形成認知、影片觀看、個人檔案瀏覽',
      creatives: '品牌宣言、受眾痛點、空間故事',
    },
    {
      key: 'retarget', name: '互動再行銷', budget: 15000,
      audience: 'IG 互動者、影片觀看者、網站訪客、既有活動名單',
      goal: '優先通知、試營運登記',
      creatives: '空間揭露、試營運、人物與真實體驗',
    },
    {
      key: 'action', name: '具體行動', budget: 5000,
      audience: '高互動者與表單訪客',
      goal: '報名、詢問與到店',
      creatives: '導覽、活動、會員與正式開幕',
    },
  ];

  // 四期釋放節奏（合計 $50,000 廣告預算）
  const RELEASE = [
    { from: '2026-07-15', to: '2026-08-15', budget: 3000, phase: '品牌重置', task: '測試 KK、裝修、受眾痛點三類內容' },
    { from: '2026-08-16', to: '2026-09-15', budget: 7000, phase: '共同打造', task: '放大表現最佳系列，累積影片與互動受眾' },
    { from: '2026-09-16', to: '2026-10-12', budget: 15000, phase: '新址揭露', task: '新址揭露、試營運名單與創作者內容' },
    { from: '2026-10-13', to: '2026-10-31', budget: 25000, phase: '試營運', task: '真實體驗、再行銷與正式開幕倒數' },
  ];
