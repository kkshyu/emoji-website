...
<h4>第二條　贈點與兌換規則</h4>
<p>乙方於付款成功時獲贈點數 2,000 點（預設一年效期），得兌換二樓淋浴、膠囊與娛樂室等指定服務（淋浴 7 點／次；膠囊與娛樂室各 10 點／小時，須為 Active 會員）。贈點不得轉讓、不得折換現金；購買點另依點數規則辦理。</p>
<h4>第三條　會費與付款</h4>
...
<h4>第五條　條件式服務揭露</h4>
<p>二樓膠囊與遊樂室之休憩服務，於主管機關書面確認完成前屬條件式服務；確認完成前，乙方之贈點得依會員規章兌換已開放之服務項目，細節依會員規章辦理。</p>
<h4>第六條　退費</h4>
...
function renderAgreement(certId) {
  ...
  <div class="agreement">
    ...
    <h4>第五條（條件式服務揭露）</h4>
    <p>二樓膠囊與遊樂室之休憩服務，於主管機關書面確認完成前屬條件式服務；確認完成前，乙方之贈點得依會員規章兌換已開放之服務項目，細節依會員規章辦理。乙方確認已知悉並同意上述安排。</p>
    <h4>第六條（退費）</h4>
